    ...
    function Html5Hlsjs(source, tech) {
        ...
        function _notifyVideoQualities() {
            if (_metadata) {
                ...
                if (tech.options_.hlsjsConfig.startLevel) {
                    var target_start_level = (tech.options_.hlsjsConfig.startLevel > _metadata.levels.length - 1) ? (_metadata.levels.length - 1) : tech.options_.hlsjsConfig.startLevel;
